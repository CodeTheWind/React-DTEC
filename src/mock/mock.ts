...
// 文章列表 - 基本
Mock.mock(`${BASE_URL}/article/get/list?page=1&category=0&keyword=`, 'get', {
  "msg": "全部文章列表",
  "state": 0,
  "data": [
    {
...
Mock.mock(`${BASE_URL}/article/get/list/user?ids=5e675a60ea0bf43770597926`, 'get', {
  ...
  "data": [
    ...
    },
    {
      ...
      "views": 7,
      "likes": 1,
      "_id": "5e904adac6941d3ca0a26fee",
      "title": "返回了总条数",
      "des": "水水水水水水水水水水水水水水水水水水",
      "category": {
        "_id": "5e8df2b29c313e4b404150c8",
        "typeId": "1003",
        "typeName": "网络安全",
    ...
    },
    {
      ...
      "category": {
        ...
        "typeName": "人工智能",
        "createdDate": "2020-04-08 23:51:54",
        "creator": "5e6908b3c371241144d4035f",
        "__v": 0
      },
      "date": "2020-04-09 13:29:46",
      "author": "5e675a60ea0bf43770597926",
...
// 收藏的文章列表
Mock.mock(`${BASE_URL}/article/get/collections?ids=5e675a60ea0bf43770597926`, 'get', {
  "msg": "用户收藏列表",
  "state": 0,
  "data": [
    {
      "_id": "5ea041c9a05ba50f2457aad3",
      "user": "5e675a60ea0bf43770597926",
      "article": {
        "tags": [
          "测试",
          "最好的",
        ...
        "title": "测试文章",
        "des": "测试文章简述",
        "content": "<h2>内容飒飒水水水水水水水水水水水水水水水水水水水</h2><p><br></p><p><br></p><h1>vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv</h1><p><br></p><h1>啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦</h1>",
        "category": {
          "_id": "5e8dea689ab5e03540871397",
          "typeName": "前端"
        },
...
// 获取用户列表
Mock.mock(`${BASE_URL}/admin/get/userlist?page=1&keyword=`, 'get', {
  "msg": "用户列表",
  "state": 200,
  "data": [
    {
